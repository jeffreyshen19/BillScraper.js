...
var printBill = function(bill, callback){
  if(typeof bill != "object") throw new TypeError("'bill' needs to be an object", "printBill.js", 42);
  if(callback == null) throw new TypeError("A callback needs to be included", "printBill.js", 43);
  ...
  try{
    ...
    throw new Error("JSON supplied must be a valid bill", "printBill.js", 54);
  }
};

...
var tagBill = function(bill, callback, options){
  ...
  if(typeof maxTags != "number") throw new TypeError("'options.maxTags' must be a number", "tagBill.js", 27);
  if(typeof bill != "object") throw new TypeError("'bill' needs to be an object", "tagBill.js", 28);
  if(callback == null) throw new TypeError("A callback needs to be included", "tagBill.js", 29);
  if(!("head" in bill) || !("body" in bill)) throw new TypeError("The bill supplied needs to be the output of printBill.js", "tagBill.js", 30);
  ...
  try{
    ...
    throw new Error("JSON supplied must be a valid bill", "tagBill.js", 61);
  }
};

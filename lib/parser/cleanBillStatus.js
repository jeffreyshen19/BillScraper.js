...
var cleanBillStatus = function(bill, callback){
  if(typeof bill != "object") throw new TypeError("'bill' needs to be an object", "cleanBillStatus.js", 30);
  if(callback == null) throw new TypeError("A callback needs to be included", "cleanBillStatus.js", 31);
  ...
  try{
    ...
    if(typeof billCopy.cosponsors != "string"){
    ...
    throw new Error("JSON supplied must be a valid bill", "cleanBillStatus.js", 111);
  }
};

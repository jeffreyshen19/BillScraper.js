...
var cleanBill = function(bill, callback){
  if(typeof bill != "object") throw new TypeError("'bill' needs to be an object", "cleanBill.js", 29);
  if(callback == null) throw new TypeError("A callback needs to be included", "cleanBill.js", 30);
  ...
  try{
    ...
    throw new Error("JSON supplied must be a valid bill", "cleanBill.js", 60);
  }
};

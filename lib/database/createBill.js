...
var createBill = function(bill, options){
  ...
  if(typeof bill != "string") throw new TypeError("'bill' needs to be a string");
  if(!/^BILLS-11[3-5](s|hr)[0-9]+[a-z0-9]{2,}$/i.test(bill)) throw new TypeError("'bill' needs to be a valid bill name");
